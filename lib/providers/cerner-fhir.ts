...
export const cernerFhirProvider: PatientProvider = {
  ...
  async getPatient(id: string): Promise<PatientDetail | null> {
    ...
    return {
      ...
      isIntubated: false,
      bpTrend: 'stable',
      neuro: { checkFreq: 'Per orders', lastCheck: 'See flowsheet', lastCheckTime: '', rass: 'See flowsheet', rassGoal: 'Per orders' },
      respiratory: { mode: 'See flowsheet', o2Device: 'See flowsheet' },
      cardiac: { hr: 'See monitor', rhythm: 'See telemetry', bp: 'See monitor', bpTrend: 'stable', pressors: [], mapGoal: '≥65' },
      lines: [],
      drips: [],
      labs: [],
      cultures: [],
